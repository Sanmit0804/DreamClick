...
const About = () => {
  return (
    <div className="min-h-[calc(100vh-8rem)] bg-background text-foreground flex items-center justify-center px-4 py-16 sm:px-6 sm:py-20">
      <div className="max-w-4xl text-center space-y-4 sm:space-y-6 animate-page-enter">
